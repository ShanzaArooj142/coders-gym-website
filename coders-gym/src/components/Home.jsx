    ...
    >
      ...
      <div className="mx-18 flex items-center justify-between">
        <div className="flex flex-col gap-5">
          <h1 className="text-gray-900 font-bold text-6xl mt-40 leading-20">
          ...
          <button className="mt-5 text-2xl font-semibold h-12 w-38 rounded-sm bg-[#FF8901]">
            Order Now
          </button>
        </div>
        <div className="mt-20 mr-10">
          <img src="/img1.webp" alt="Gym" className="w-[450px] h-[500px] object-contain" />
        </div>
      </div>
    </div>
  )
